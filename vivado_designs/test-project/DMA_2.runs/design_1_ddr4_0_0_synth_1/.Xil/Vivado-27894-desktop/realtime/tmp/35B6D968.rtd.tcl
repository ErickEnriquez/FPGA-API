...
set genomeRtd $env(RT_TMP)/35B6D968.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {design_1_ddr4_0_0_ddr4_mem_intfc__GC0}]"
puts "this genome's rtd file is $genomeRtd"
source $::env(HRT_TCL_PATH)/rtSynthPrep.tcl
source $::env(RT_TMP)/parameters.tcl
rt::set_parameter parallelChildUpdateCell true; rt::set_parameter parallelTimingMode true; rt::set_parameter parallelTimingModeRound 1; set rt::SDCFileList ./.Xil/Vivado-27894-desktop/realtime/tmp///parallel_timing.xdc; 
set genomeName [subst -nocommands -novariables {design_1_ddr4_0_0_ddr4_mem_intfc__GC0}]
