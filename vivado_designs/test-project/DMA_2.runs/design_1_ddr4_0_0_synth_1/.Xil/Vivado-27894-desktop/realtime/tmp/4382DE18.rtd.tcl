...
set genomeRtd $env(RT_TMP)/4382DE18.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {design_1_ddr4_0_0_ddr4_GT0}]"
...
set genomeName [subst -nocommands -novariables {design_1_ddr4_0_0_ddr4_GT0}]
