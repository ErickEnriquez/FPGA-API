...
set genomeRtd $env(RT_TMP)/514EED08.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {ddr4_v2_2_8_cal_addr_decode__GB0}]"
...
set genomeName [subst -nocommands -novariables {ddr4_v2_2_8_cal_addr_decode__GB0}]
