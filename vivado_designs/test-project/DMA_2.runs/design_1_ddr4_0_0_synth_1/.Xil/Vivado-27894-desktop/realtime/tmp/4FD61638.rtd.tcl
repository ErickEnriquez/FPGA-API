...
set genomeRtd $env(RT_TMP)/4FD61638.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {ddr4_v2_2_8_cal_pi__GB2}]"
...
set genomeName [subst -nocommands -novariables {ddr4_v2_2_8_cal_pi__GB2}]
