...
set genomeRtd $env(RT_TMP)/4D6A80D8.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {xdma_v4_1_4_udma_top__GCB0}]"
...
set genomeName [subst -nocommands -novariables {xdma_v4_1_4_udma_top__GCB0}]
