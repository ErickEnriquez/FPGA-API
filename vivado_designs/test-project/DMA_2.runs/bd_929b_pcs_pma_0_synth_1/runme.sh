...
HD_PWD='/home/luke/Capstone/FPGA_API/vivado_designs/test-project/DMA_2.runs/bd_929b_pcs_pma_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_929b_pcs_pma_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_929b_pcs_pma_0.tcl
