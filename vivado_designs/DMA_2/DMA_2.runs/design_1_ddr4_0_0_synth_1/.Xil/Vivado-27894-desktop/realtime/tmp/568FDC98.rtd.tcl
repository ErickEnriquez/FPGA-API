...
set genomeRtd $env(RT_TMP)/568FDC98.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {ddr4_v2_2_8_cal_addr_decode__GB1}]"
...
set genomeName [subst -nocommands -novariables {ddr4_v2_2_8_cal_addr_decode__GB1}]
