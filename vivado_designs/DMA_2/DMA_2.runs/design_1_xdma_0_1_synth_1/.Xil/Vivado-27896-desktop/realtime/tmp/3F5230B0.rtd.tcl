...
set genomeRtd $env(RT_TMP)/3F5230B0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {xdma_v4_1_4_vul_rdwr_eng__parameterized1}]"
...
set genomeName [subst -nocommands -novariables {xdma_v4_1_4_vul_rdwr_eng__parameterized1}]
