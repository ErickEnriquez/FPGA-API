...
set genomeRtd $env(RT_TMP)/4EF130E0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {xdma_v4_1_4_dma_pcie_req__GB2}]"
...
set genomeName [subst -nocommands -novariables {xdma_v4_1_4_dma_pcie_req__GB2}]
