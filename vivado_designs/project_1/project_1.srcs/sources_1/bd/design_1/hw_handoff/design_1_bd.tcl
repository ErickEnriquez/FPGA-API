...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.GPIO2_BOARD_INTERFACE {rotary_switch} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.pciebar2axibar_axist_bypass {0xE0000000} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports rotary_switch] [get_bd_intf_pins axi_gpio_0/GPIO2]
  ...
  connect_bd_intf_net -intf_net xdma_0_M_AXI_BYPASS [get_bd_intf_pins axi_smc/S01_AXI] [get_bd_intf_pins xdma_0/M_AXI_BYPASS]
